...
export const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex flex-col items-center justify-center pt-20 px-6 overflow-hidden bg-background text-foreground selecting-none selection:bg-primary/20">
